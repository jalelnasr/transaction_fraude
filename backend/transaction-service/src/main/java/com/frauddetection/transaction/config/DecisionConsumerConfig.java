...
@Configuration
public class DecisionConsumerConfig {
    ...
    public ConsumerFactory<String, DecisionDTO> decisionConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "transaction-service-decision-group");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, DecisionDTO> decisionKafkaListenerContainerFactory(
