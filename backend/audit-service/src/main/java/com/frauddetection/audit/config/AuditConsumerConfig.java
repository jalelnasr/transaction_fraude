package com.frauddetection.audit.config;
...
public class AuditConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, AuditEventDTO> auditEventConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, AuditEventDTO> kafkaListenerContainerFactory(
            ConsumerFactory<String, AuditEventDTO> auditEventConsumerFactory) {
